...
// import FooterUserMenu from "./FooterUserMenu";
import dynamic from "next/dynamic";
const FooterUserMenu = dynamic(() => import("./FooterUserMenu"));

const FooterNavbar = async () => {
  return (
    // CHANGE: Use grid-cols-5 to create 5 equal slots
    <div className="md:hidden fixed bottom-0 left-0 w-full h-[70px] bg-white border-t border-gray-200 z-[5000] grid grid-cols-5 items-center px-2">
      {/* Left Side: Takes up 2 columns (40%) */}
      <div className="col-span-2 flex justify-around items-center w-full">
        <Link
          href={WEBSITE_HOME}
        ...
        <Link
          href={WEBSITE_MOBILE_CATEGORIES}
          className="flex justify-center items-center w-full"
        >
          <BiSolidCategory className="text-2xl" />
        </Link>
      ...
      {/* Right Side: Takes up 3 columns (60%) */}
