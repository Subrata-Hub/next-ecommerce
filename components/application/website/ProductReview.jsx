...
const ProductReview = ({ productId }) => {
  ...
  const fetchReview = async (pageParams) => {
    const { data: getReviewData } = await axios.get(
      `/api/review/get/${productId}?page=${pageParams}`
    );
      ...
      <div className="p-3">
          ...
          <div className="md:w-1/2 w-full md:flex md:gap-10 md:mb-0 mb-5">
            <div className="md:w-[200px] w-full md:mb-0 mb-5">
              ...
              <p className="text-center mt-3">
                ({reviewCount?.totalReview} Rating & Review)
              </p>
            </div>
        ...
        {isReview && auth && (
          <div className="p-5">
            ...
            {/* {!auth ? (
              <>
                <p className="mt-2">Login to submit review</p>
        ...
        <div className="mt-10 border-t pt-5 text-xl font-semibold">
          <h5>{data?.pages[0]?.totalReview} Reviews</h5>
